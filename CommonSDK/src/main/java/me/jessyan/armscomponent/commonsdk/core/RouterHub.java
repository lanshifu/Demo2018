...
public interface RouterHub {
    ...
    String USER = "/user";//用户中心组件
    String DEMO = "/demo";//demo模块
     ...
     * 用户中心
     */
    String USER_SERVICE_GOLDINFOSERVICE = USER + SERVICE + "/UserService";

    String USER__USERFCENTERACTIVITY = USER + "/UserCenterActivity";


    /**
     * demo
     */
    String DEMO_SERVICE_DEMOERVICE = DEMO + SERVICE + "/DemoService";

    String DEMO__DEMOACTIVITY = DEMO + "/DemoActivity";
}
